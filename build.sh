### CR: https://julhe.github.io/posts/building-an-android-app-with-rust-and-sdl2/

#NOTE: Dont't forget to modify these vars to your setup
JNI_LIBS=./android-project/app/src/main/jniLibs
LIB_NAME=libmain.so
SDL2_LIBS="C:\Users\timelessnesses\Downloads\SDL-release-2.28.5\SDL-release-2.28.5\libs" # sdl2 lib here
BUILD_MODE=release
